...
const Projects = () => {
  ...
  return (
    <section id="projects" className="sm:px-10 px-5 my-20">
      ...
      <div className="flex flex-col sm:flex-row mt-12 gap-5">
        <div className="w-full h-full sm:w-1/2 sm:h-1/2 flex flex-col gap-5 relative sm:p-10 py-10 px-5 shadow-2xl shadow-black-200">
