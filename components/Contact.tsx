...
const tempKey = process.env.EMAILJS_TEMP_KEY;
      ...
      <div className="relative min-h-screen flex items-center justify-center flex-col">
        ...
        <div className="max-w-xl relative z-10 sm:px-10 px-5 sm:mt-12">
          ...
          <p className="text-lg text-white-200 mt-3">
            I&apos;m excited to bring your ideas to life! Whether you&apos;re
            building something new, refining your existing platform, or working
            on a unique project, I&apos;m here to help every step of the way.
          </p>
          <form
            ref={formRef}
          ...
          >
            ...
            <label className="space-y-3">
              <span className="text-lg text-white-600">Your <span className="text-purple">Message</span></span>
              <textarea
                name="message"
                value={form.message}
                onChange={handleChange}
